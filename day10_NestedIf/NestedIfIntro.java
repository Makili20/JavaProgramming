...
public class NestedIfIntro {
    public static void main(String[] args) {
        ...
        if (hasId) {//if the person has Id
            ...
            if (age >= 21) {//if the person is 21 yrs old or older
                System.out.println("Eligible to buy alcohol");
            } else {//if the person is less than 21 yrs old
                System.out.println("Not eligible to nuy alcohol");
            }
        ...
        if (number >= 1 && number <= 7) {
            //if the number is the valid number(1
            //7 options
