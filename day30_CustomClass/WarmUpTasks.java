...
public class WarmUpTasks {
        ...
        public static void main(String[] args) {
            ...
            numbers.addAll(Arrays.asList(1,2,3,0,5,6,0,7,8,0));
            ...
            list2.addAll(Arrays.asList(1,2,0,5,0,7,8,0));
            ...
            ArrayList<Character>letters=new ArrayList<>(chars);//add all gthe characters
            letters.removeIf(p->!Character.isLetter(p));//rremove the characters that are not letters
            System.out.println("letters = " + letters);

            ArrayList<Character> digits=new ArrayList<>(chars);//add all the characters
            digits.removeIf(p->!Character.isDigit(p));//remove all tghe characters that are not digits
